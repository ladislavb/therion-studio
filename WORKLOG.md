...
- Continue migrating touched hand-rolled tests to QTest where the dependency/runtime boundary is already clear; core background-metadata parser and serializer coverage now runs as named slots in `TherionCoreQTests`.
