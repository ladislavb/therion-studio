...
- Continue migrating touched hand-rolled tests to QTest where the dependency/runtime boundary is already clear; core background-metadata, command-option-parser, document-parser, and XVI-parser coverage now runs as named slots in `TherionCoreQTests`.
