...
2. Continue watcher W2-W4 in `PROJECT_ASYNC_COORDINATION_PLAN.md`: add generation-keyed background inventory
   coordination, then apply watcher deltas on the GUI thread. SQL S1-S5 and watcher W1 are complete.
